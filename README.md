...
### 🛠️ Languages & Tools
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,python,go,java,js,ts,pytorch,tensorflow,aws,gcp,react,django,linux,git,docker,kubernetes,postgres,mysql,redis,nginx,fastapi,nodejs,graphql,terraform" />
